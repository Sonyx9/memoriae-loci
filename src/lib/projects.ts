...
export const projects: Project[] = [
  ...
  },
  {
    ...
    heroImageAlt: 'Černobílá fotografie muže v uniformě před budovou z minulého století',
    heroImageTitle: 'Historická fotografie vojáka',
    heroImageDescription: 'Starodávná černobílá fotografie zobrazující muže v uniformě. Muž se usmívá a stojí před budovou s historickou architekturou. Fotografie nese známky opotřebení a patiny.',
